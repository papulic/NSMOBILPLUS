# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-07-17 08:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postanski_broj', models.CharField(blank=True, max_length=5, validators=[django.core.validators.RegexValidator(code='Po\u0161tanski broj mora imati 5 cifara', message='Po\u0161tanski broj mora imati 5 cifara', regex='^.{5}$')])),
                ('grad', models.CharField(blank=True, max_length=25)),
                ('kontakt_telefon', models.CharField(blank=True, max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('napomena', models.CharField(blank=True, max_length=100)),
